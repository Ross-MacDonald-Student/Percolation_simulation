function [points,exclusion_points,sheet_center_vector,Range,length] = Generate_points_exclustion(width,aspect_ratio,packing_fraction,sheet_no,electron_scaling)
